...
<ol>""" % (context.getCountryName(), DateTime().strftime('%d %B %Y'), context.title_or_id(), context.absolute_url(), context.absolute_url())
...
context.manage_addFeedback(title="Natura 2000 electronic data submission", feedbacktext=l_ret, automatic=1, content_type='text/html')

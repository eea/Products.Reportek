...
for x in container.objectValues('Report Collection'):
  if not hasattr(x,'un'):
    ...
    x.un.manage_addCollection(title='Barcelona Convention', descr='', year='', endyear='', 
                        partofyear='', country=x.id, locality='', 
                        dataflow_uris=['http://rod.eionet.eu.int/obligations/424', 'http://rod.eionet.eu.int/obligations/425',
'http://rod.eionet.eu.int/obligations/426', 'http://rod.eionet.eu.int/obligations/427',
'http://rod.eionet.eu.int/obligations/428', 'http://rod.eionet.eu.int/obligations/429',
'http://rod.eionet.eu.int/obligations/430'
], allow_collections=0, 

...
for x in container.objectValues("Report Collection"):
    if not hasattr(x, "un"):
        ...
        x.un.manage_addCollection(
            ...
            locality="",
            dataflow_uris=[
                "http://rod.eionet.europa.eu/obligations/424",
                "http://rod.eionet.europa.eu/obligations/425",
                "http://rod.eionet.europa.eu/obligations/426",
                "http://rod.eionet.europa.eu/obligations/427",
                "http://rod.eionet.europa.eu/obligations/428",
                "http://rod.eionet.europa.eu/obligations/429",

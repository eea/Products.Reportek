...
if (
    schema
    == "http://biodiversity.eionet.europa.eu/schemas/barcelona_convention/barcelona.xsd"
):
    ...
    schema
    == "http://biodiversity.eionet.europa.eu/schemas/barcelona_convention/dumping.xsd"
):
    ...
    schema
    == "http://biodiversity.eionet.europa.eu/schemas/barcelona_convention/hazardous.xsd"
):
    ...
    schema
    == "http://biodiversity.eionet.europa.eu/schemas/barcelona_convention/lbs.xsd"
):
    ...
    schema
    == "http://biodiversity.eionet.europa.eu/schemas/barcelona_convention/offshore.xsd"
):
    ...
    schema
    == "http://biodiversity.eionet.europa.eu/schemas/barcelona_convention/prevention.xsd"
):
    ...
    schema
    == "http://biodiversity.eionet.europa.eu/schemas/barcelona_convention/spa-biodiversity.xsd"
):

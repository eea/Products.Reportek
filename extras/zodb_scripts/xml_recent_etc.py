...
search_args = {'meta_type':'Report Envelope', 'sort_on':'reportingdate','sort_order':'reverse'}

if country_code is not None:
    if len(country_code) == 2:
        search_args['country'] = context.localities_iso_dict(string.upper(country_code))['uri']

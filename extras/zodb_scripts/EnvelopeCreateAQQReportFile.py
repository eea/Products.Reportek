...
if not language:
    err_msg.append("Missing language parameter")
if not schema:
    err_msg.append("No schema given")
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form1.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form2.xsd"
):
    if not filename:
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form3.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form5.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form7.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form8.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form9.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form10.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form12.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form13.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form14.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form15.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form17.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form18.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form19.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form20.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form22.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form23.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form24.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form26.xsd"
):
...
if (
    schema
    == "http://air-climate.eionet.europa.eu/schemas/AirQualityQuestionnaire/AirQualityQuestionnaire-form27.xsd"
):
...
edit_url = (
    context.getWebQ_MenuEnvelope_URL()
    + "?language=En&envelope="

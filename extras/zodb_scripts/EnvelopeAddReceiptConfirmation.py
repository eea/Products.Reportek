...
<ol>""" % (obligations_para, context.getCountryName(), DateTime().strftime('%d %B %Y'), context.title_or_id(), context.absolute_url(), context.absolute_url())
...
""" % context.getPreviousActor(str(int(workitem_id) - 2))

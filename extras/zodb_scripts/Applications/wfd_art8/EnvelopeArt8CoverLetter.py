...
<p>This confirmation letter shows the status of national data submissions to
...
<p>The letter is automatically generated when the authorised national data
 reporter has released the respective reporting information inside the
  Central Data Repository (CDR).</p>

<p>The following delivery has been submitted for <strong>%s</strong> and was
 released on <strong>%s</strong>.</p>
...
<p>This confirmation letter is electronically generated by the Reportnet
 system and therefore not signed.</p>

<p>According to the WISE Reporting Arrangements agreed at the WFD Regulatory
 Committee in March 2007, this cover letter is generated to be printed and

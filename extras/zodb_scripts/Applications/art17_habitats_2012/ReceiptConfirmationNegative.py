...
if l_envelope.dataflow_uris == art17:
    l_ret_body = """
<ul>
<li>not all mandatory files (including projection file for spatial data) have
 been submitted or are valid (see <a href="%s">AutomaticQA result for envelope
 </a>)</li>
<li>habitats report does not conform to the data model defined in
 the XML schema %s</li>
...
# Red lists
    ...
    l_ret_body = """
<ul>
<li>not all mandatory files (birds reports and birds check-list) have been
 submitted or are valid (see <a href="%s">AutomaticQA result for envelope
 </a>)</li>
<li>bird species report does not conform to the data model defined in the XML
 Schema %s</li>
</ul>
...
<p>The conditions for accepting Member State deliveries are outlined in
 Annex 1 "Rules for the acceptance of Member State deliveries in Reportnet"
  of the Delivery Manual for Articles 12 and 17.</p>
<p>For additional information contact
 <a href="mailto:reportingart12art17@mnhn.fr">reportingart12art17@mnhn.fr</a>
</p>
...
# Red lists
    ...
    l_ret_foot = """
<p>The conditions for accepting deliveries are outlined in Annex 1 "Rules for
 the acceptance of Red List deliveries in Reportnet" of the Delivery Manual
  for European Red List of Birds.</p>
<p>For additional information contact
 <a href="mailto:reportingart12art17@mnhn.fr">reportingart12art17@mnhn.fr</a>
</p>

...
class QAScriptTest(BaseUnitTest):
    ...
    def test_invoke_local_script(self):
        ...
        mock_file = BytesIO(self.doc_content.encode("utf-8"))
    ...
    def test_local_script_attributes_initialisation(self):
        ...
        self.assertEqual("application/msaccess", qascript.content_type_in)
    ...
    def test_local_script_found_by_workflow(self):
        ...
        self.assertEqual(
            ("foo.txt", "loc_mdb_workflow_qascript"),
    ...
    def test_workflow_scripts_are_filtered_by_content_type(self):
        ...
        self.assertEqual([qa_repository.mdb_workflow_qascript], local_scripts)
    ...
    def test_workflow_scripts_are_found_by_content_type(self):
        ...
        self.assertEqual([qa_repository.doc_workflow_qascript], local_scripts)

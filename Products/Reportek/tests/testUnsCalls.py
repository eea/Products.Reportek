...
class UNSCallsTest(BaseUnitTest):
    ...
    def test_subscribe_to_dataflow(self, mock_dataflow_lookup):
        ...
        self.engine.subscribeToUNS(
            dataflow_uris=[mock_dataflow["uri"]], filter_event_types=[event]
        )
        ...
        makeSubscription.assert_called_once_with(
            ...
            [
                {
                    "http://rod.eionet.europa.eu/schema.rdf#event_type": event,
                    "http://rod.eionet.europa.eu/schema.rdf#obligation": mock_dataflow[
                        "TITLE"
                    ],
                },
            ],
    ...
    def test_send_notification_to_uns(self, mock_strftime, mock_time):
        ...
        mock_time.return_value = 1338217590.56

...
def usage():
    "\tUsage: %s <big po file with tr messages> <small po file that should\
     have msgstr translated>\n\tThe result\
      will be in <po file>.out" % sys.argv[0]
...
if __name__ == "__main__":
    ...
    out_po.write("\n".join(po_header_untr))
    out_po.write("\n")
    for key, block in byMsgid_untr.items():

...
remote_feedback_log = logging.getLogger("Products.Reportek.RemoteApplication.feedback")
remote_conversion_log = logging.getLogger(
    "Products.Reportek.EnvelopeCustomDataflows.conversion"
)
converter_detection_log = logging.getLogger("Products.Reportek.Converters.detection")

...
reportek.utils.forwardable_envelopes = {
  load: function() {
      ...
      "columnDefs": [
        {
          ...
          "render": function (data, type, full, meta) {
            return '<input type="checkbox" name="envelopes:list" class="toggledCB" value="' + full.env.url + '">';
          }
        },
        {
          "targets": 1,
...
$(document).ready(function () {
  reportek.utils.forwardable_envelopes.load();
});

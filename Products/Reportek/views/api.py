...
class ReportekApi(BrowserView):
    ...
    def search_envelopes(
        self, obligation, released=True, rejected=False, start_date=None, end_date=None
    ):
        results = []
        ...
        if start_date and end_date:
            ...
            reportingdate = {"query": DateTime(start_date), "range": "min"}
        elif end_date:
            reportingdate = {"query": DateTime(end_date), "range": "max"}
        else:
            reportingdate = None
        ...
        for brain in brains:
            ...
            envelope_properties = {
                ...
                "dataflow_uris": (
                    env.dataflow_uris
                    if isinstance(env.dataflow_uris, list)
                    else list(env.dataflow_uris)
                ),
                "country": env.country,
    ...
    def get_released_envelopes(self, obligation, start_date=None, end_date=None):
        ...
        return self.search_envelopes(
            obligation, start_date=start_date, end_date=end_date
        )
    ...
    def get_unreleased_envelopes(self, obligation, start_date=None, end_date=None):
        ...
        return self.search_envelopes(
            obligation, released=False, start_date=start_date, end_date=end_date
        )
    ...
    def get_rejected_envelopes(self, obligation, start_date=None, end_date=None):
        ...
        return self.search_envelopes(
            obligation, rejected=True, start_date=start_date, end_date=end_date
        )

...
class DataflowMappings(Folder):
    ...
    def getSchemaObjectsForDataflows(self, dataflow_uris, web_form_only, catalog=True):
        ...
        """
        res = []
        mapping = self.get_dataflow_mapping_records(
    ...
    def getSchemasForDataflows(
        self, dataflow_uris=None, web_form_only=False, catalog=True
    ):
        """
        Returns schemas for one or many dataflows
    ...
    def get_webform_url_for_schema(
        self, schema, dataflow_uris=None, web_form_only=False, catalog=True
    ):

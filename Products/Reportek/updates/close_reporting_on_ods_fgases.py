...
def cut_permissions(folder):
    folder.manage_permission(
        "Access contents information", roles=["Anonymous", "Manager"]
    )
    folder.manage_permission("Add Documents, Images, and Files", roles=["Manager"])
    folder.manage_permission("Add Envelopes", roles=["Manager"])
    folder.manage_permission(
        "Audit Envelopes", roles=["ClientFG", "ClientODS", "Manager"]
    )
    ...
    folder.manage_permission(
        "Release Envelopes", roles=["ClientFG", "ClientODS", "Manager"]
    )
    folder.manage_permission("Take ownership", roles=["Manager"])
    folder.manage_permission("Use OpenFlow", roles=["ClientFG", "ClientODS", "Manager"])

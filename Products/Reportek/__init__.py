...
def create_reportek_objects(app):
    ...
    if REPORTEK_DEPLOYMENT == DEPLOYMENT_BDR:
        from . import RegistryManagement
...
misc_ = {
    "collection.gif": ImageFile("www/images/collection.gif", globals()),
    "referral.gif": ImageFile("www/images/referral.gif", globals()),
    "Converters": ImageFile("www/images/converter.gif", globals()),
    "QARepository": ImageFile("www/images/qarepo.gif", globals()),
    "feedback_gif": ImageFile("www/images/feedback.gif", globals()),
    ...
    "lockicon_gif": ImageFile("www/images/lockicon.gif", globals()),
    "plus_gif": ImageFile("www/images/plus.gif", globals()),
    "minus_gif": ImageFile("www/images/minus.gif", globals()),
    "sort_asc": ImageFile("www/images/sort_asc.gif", globals()),
    "sort_desc": ImageFile("www/images/sort_desc.gif", globals()),
    "sortnot": ImageFile("www/images/sortnot.gif", globals()),
    "accepted": ImageFile("www/images/accepted.gif", globals()),
    "work_in_process": ImageFile("www/images/work_in_process.gif", globals()),
    "Transition.gif": ImageFile("www/images/Transition.gif", globals()),
    "Activity.gif": ImageFile("www/images/Activity.gif", globals()),
    "Process.gif": ImageFile("www/images/Process.gif", globals()),
    "Workitem.gif": ImageFile("www/images/Workitem.gif", globals()),
    "feedback_comment_png": ImageFile("www/images/comment.png", globals()),
}
